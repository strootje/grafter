...
export class MergedFile extends File {
	...
	constructor(source: string, file: File) {
		super(file.Namespace, file.Type, file.Name, file.Extension);
		this.files = {};
		this.AddSource(source, file);
	}

	public get Files(): File[] { return Object.values(this.files); }
	public get Length(): number { return this.Files.length; }
